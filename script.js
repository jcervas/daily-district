...
function _syncPostgameRibbonHeight() {
  ...
  // getBoundingClientRect() is the border box — the ribbon has no margin, so this is
  // already its full on-screen footprint (its --bg top border is part of the border box).
...
document.addEventListener('DOMContentLoaded', () => {
  ...
  // About / Donate — every remaining donate entry point (header icon, welcome splash)
  // opens the same About modal instead of navigating straight out to GiveCampus; the
  // modal itself holds the actual "Donate to CMU" link. The result modal's own former
  // donate button is now "View District Profile" (a plain .modal-close, wired below).
  ...
  ['donate-btn', 'welcome-donate-btn'].forEach(id => {
